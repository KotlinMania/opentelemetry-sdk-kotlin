...
class SamplerTest {
    ...
    fun testAlwaysOnAndAlwaysOff() {
        val onResult = Sampler.AlwaysOn.shouldSample(
            parentContext = null,
        ...
        val offResult = Sampler.AlwaysOff.shouldSample(
            parentContext = null,
            traceId = TraceId(1u, 1u),
            name = "test",
            spanKind = SpanKind.INTERNAL,
    ...
    fun testParentBasedSampler() {
        ...
        val noParentResult = parentSampler.shouldSample(
            parentContext = null,
            traceId = TraceId(1u, 1u),
            name = "test",
            spanKind = SpanKind.INTERNAL,
        ...
        val sampledParent = SpanContext(
            traceId = TraceId(1u, 1u),
            spanId = SpanId(1u),
            traceFlags = TraceFlags.SAMPLED,
        )
        val sampledResult = parentSampler.shouldSample(
        ...
        val unsampledParent = SpanContext(
            traceId = TraceId(1u, 1u),
            spanId = SpanId(1u),
            traceFlags = TraceFlags.DEFAULT,
        )
        val unsampledResult = parentSampler.shouldSample(
    ...
    fun testTraceIdRatioBased() {
        ...
        val resultOn = samplerOn.shouldSample(
            parentContext = null,
        ...
        val resultOff = samplerOff.shouldSample(
            parentContext = null,
            traceId = TraceId(0u, 100u),
            name = "test",
            spanKind = SpanKind.INTERNAL,
