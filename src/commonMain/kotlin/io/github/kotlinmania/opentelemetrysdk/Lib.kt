...
//     // Choose an exporter like standard output SpanExporter
...
//         .build()
//     val tracer = provider.tracer("readme-example")
//
//     tracer.inSpan("doing-work") { cx ->
...
// val meter = global.meter("my-service")
//
// // create an instrument
// val counter = meter.u64Counter("my-counter").build()
//
...
// ## Crate Feature Flags
//
// The upstream Rust crate uses Cargo feature flags to control the
...
//
// * jaeger remote sampler: Enables the Jaeger remote sampler.
//
// For logs the following feature flags are available:
//
// * spec unstable logs: control the log level
//
...
//
// * experimental async runtime: Enables the experimental Runtime interface
//   and related functionality.
// * rt-tokio: Spawn telemetry tasks using tokio multi-thread runtime.
