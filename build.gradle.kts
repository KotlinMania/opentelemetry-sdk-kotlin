...
kotlin {
    ...
    val xcf = XCFramework("OpentelemetrySdk")

    macosArm64 {
        binaries.framework { baseName = "OpentelemetrySdk"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "OpentelemetrySdk"; xcf.add(this) }
    }
    ...
    swiftExport {
        ...
        flattenPackage = "io.github.kotlinmania.opentelemetrysdk"
    }

    android {
        namespace = "io.github.kotlinmania.opentelemetrysdk"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "opentelemetry-sdk-kotlin", version.toString())

    pom {
        name.set("opentelemetry-sdk-kotlin")
        description.set("Kotlin Multiplatform port of open-telemetry/opentelemetry-rust - The SDK for the OpenTelemetry metrics collection and distributed tracing framework")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/opentelemetry-sdk-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/opentelemetry-sdk-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/opentelemetry-sdk-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/opentelemetry-sdk-kotlin.git")
        }
    }
}
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleOpentelemetrySdkXCFramework",
    "assembleOpentelemetrySdkDebugXCFramework",
    "assembleOpentelemetrySdkReleaseXCFramework",
    "assembleDebugIosFatFrameworkForOpentelemetrySdkXCFramework",
    "assembleReleaseIosFatFrameworkForOpentelemetrySdkXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForOpentelemetrySdkXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForOpentelemetrySdkXCFramework",
    "assembleDebugMacosFatFrameworkForOpentelemetrySdkXCFramework",
    "assembleReleaseMacosFatFrameworkForOpentelemetrySdkXCFramework",
    "assembleDebugTvosFatFrameworkForOpentelemetrySdkXCFramework",
    "assembleReleaseTvosFatFrameworkForOpentelemetrySdkXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForOpentelemetrySdkXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForOpentelemetrySdkXCFramework",
    "assembleDebugWatchosFatFrameworkForOpentelemetrySdkXCFramework",
    "assembleReleaseWatchosFatFrameworkForOpentelemetrySdkXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForOpentelemetrySdkXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForOpentelemetrySdkXCFramework",
