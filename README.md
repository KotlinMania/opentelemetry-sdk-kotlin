# opentelemetry-sdk-kotlin in Kotlin
...
This is a Kotlin Multiplatform line-by-line transliteration port of [`open-telemetry/opentelemetry-rust`](https://github.com/open-telemetry/opentelemetry-rust/tree/main/opentelemetry-sdk).

**Original Project:** This port is based on [`open-telemetry/opentelemetry-rust`](https://github.com/open-telemetry/opentelemetry-rust/tree/main/opentelemetry-sdk). All design credit and project intent belong to the upstream authors; this repository is a faithful port to Kotlin Multiplatform with no behavioural changes intended.
...
> The text below is reproduced and lightly edited from [`https://github.com/open-telemetry/opentelemetry-rust/tree/main/opentelemetry-sdk`](https://github.com/open-telemetry/opentelemetry-rust/tree/main/opentelemetry-sdk). It is the upstream project's own description and remains under the upstream authors' authorship; links have been rewritten to absolute upstream URLs so they continue to resolve from this repository.
...
This Kotlin port is distributed under the same Apache-2.0 license as the upstream [`open-telemetry/opentelemetry-rust`](https://github.com/open-telemetry/opentelemetry-rust/tree/main/opentelemetry-sdk). See [LICENSE](LICENSE) (and any sibling `LICENSE-*` / `NOTICE` files mirrored from upstream) for the full text.
