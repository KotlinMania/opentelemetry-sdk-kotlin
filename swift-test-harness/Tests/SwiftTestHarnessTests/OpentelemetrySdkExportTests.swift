...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `OpentelemetrySdk.swiftmodule/`
...
//      `import OpentelemetrySdk` above would fail at compile time.
//
//   2. The static archive `libOpentelemetrySdk.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "OpentelemetrySdk" }` and
//      `flattenPackage = "io.github.kotlinmania.opentelemetrysdk"` configuration in
...
//      via the `OpentelemetrySdkLibrary` product.
//
