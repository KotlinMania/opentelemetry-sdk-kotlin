...
This file is the quick-reference operating contract for opentelemetry-sdk-kotlin. The longer
...
opentelemetry-sdk-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`opentelemetry_sdk`](https://crates.io/crates/opentelemetry_sdk). Upstream Rust is the behavioral oracle while the
